...
elseif($_POST['titre']=="" OR htmlentities($_POST['titre'])=="Pr&eacute;sentation" OR $_POST['message']=="")
	{
	...
	$sql = 'INSERT INTO wikast_edc_articles_tbl(id,auteur,titre,date,contenu) VALUES("","'.$_SESSION['pseudo'].'","'.$titrearticle.'","'.time().'","'.$message.'")' ;
	mysql_query($sql);
		...
		<div id="page">
			...
			<div id="page-EDC">
				...
				print('<div id="zone-centre">
					<form action="edc=nouveau.php?actuel='.$actuel.'&page1='.$pagearticles.'&page2='.$pageetoiles.'" method="post" id="champ" name="poster">
