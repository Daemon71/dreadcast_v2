...
<br />Cet espace est entièrement dédié à votre expression. Vous pouvez y écrire les articles que vous souhaitez faire partager à d'autres citoyens. Vous pouvez également \"étoiler\" une autre personne, c'est-à-dire la compter parmis vos favoris.
<br />");
if($_SESSION['statut']=="Joueur") $textedebienvenue .= htmlentities("Votre statut de joueur vous permet de disposer de 5 étoiles. Vous pouvez en donner et en recevoir.");
else $textedebienvenue .= htmlentities("Votre statut de VIP vous permet de disposer d'autant d'étoiles que vous le souhaitez.");
$textedebienvenue .= htmlentities("
<br />
<br />Cet article \"Présentation\" est votre carte de visite, le premier à être lu par les citoyens. Modifiez-le en cliquant sur le lien suivant : [lien url=<edc=editer.php?article=Présentation&page1=".$_GET['page1']."&page2=".$_GET['page2']."&feuille=".$_GET['feuille'].">]Modifier ma présentation[/lien].
<br />
<br />Vous pouvez également changer vos informations personnelles en cliquant ici : [lien url=<edc=infos.php#champ>]Changer mes infos perso[/lien].
<br />
