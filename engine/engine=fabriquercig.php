...
if($okcigarettes==1)
	{
	print('Vous avez réussi à fabriquer des cigarettes avec quelques feuilles et ce que vous trouvez par terre. Vous pliez votre carte d\'identité pour faire office de paquet.<br /><br /><img src="im_objets/cigarette.gif" border="0"><br /><br />Ce n\'est surement pas d\'une grande qualité mais les fumer doit faire un sacré bien !');
	}
else
	{
