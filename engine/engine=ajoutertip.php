...
if($_SESSION['statut']=="Administrateur" OR $l!=1)
	...
	if($_POST['contenu']!="")
		{
		$sql = 'INSERT INTO tips_tbl(id,auteur,tips,paru) VALUES("","'.htmlentities(stripslashes($_POST['auteur'])).'","'.htmlentities(stripslashes($_POST['contenu'])).'","non")' ;
		$req = mysql_query($sql);
		print('Le Tip\' a été ajouté. Il sera paru d\'ici quelques jours.');
		}
	else
		{
		print('<form action="#" method="post">
		Auteur: <input name="auteur" type="text" size="10" /><br /><br />
		Tip\':<br /><br /><textarea name="contenu" rows="6" cols="40"></textarea><br /><br />
