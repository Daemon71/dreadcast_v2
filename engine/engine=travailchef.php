...
if($ouvert=="non")
	{
	if(($type=="agence immobiliaire") || ($type=="boutique armes") || ($type=="boutique spécialisee") || ($type=="ventes aux encheres") || ($type=="centre de recherche") || ($type=="usine de production") || ($type=="centre de recherche"))
		{
		if($typeposte=="chef")
			{
