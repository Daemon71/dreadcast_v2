	...
	if(mysql_result($req,0,entreprise)=="Chambre des lois")
		...
		if($_SESSION['credits']>=100)
			...
			if($l==0)
				...
				{
				print('<br />Vous venez d\'acheter une Alliance.<br />Elle vient d\'être placée dans votre inventaire.');
				}	
			}
		else
			{
		...
		{
		print('<br />Il faut être de la Chambre des Lois pour pouvoir obtenir une Alliance.');
		}
	mysql_close($db);
	}
else
	{
	print('<br /><strong>Cette page est reservée aux membres de la Chambre des Lois.</strong><br />
	Cet objet permet de lier deux âmes.<br />
	Une Alliance coûte 100 Crédits. Obteniez-les des interressés.<br /><br />
