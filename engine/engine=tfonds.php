...
<form name="form2" method="post" action="engine=tff.php">
	<p><em><strong>Transf&eacute;rer des fonds depuis l'inventaire : </strong></em></p>
	<p><strong>Disponible : </strong><?php print('<i>'.$_SESSION['credits'].'</i>'); ?> Cr&eacute;dits</p>
	<p>Transf&eacute;rer
		<input name="cre" type="text" id="cre" size="6" maxlength="6">
		Cr&eacute;dits <br />
		(le budget maximum est de 100.000 Cr&eacute;dits) 
	</p>
	<p>
