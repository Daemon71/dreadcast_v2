...
if(($type=="chambre") && ($l!=1))
	...
	if($res>0)
		...
		print('<div class="barre">Proposition de Loi de <a href="engine=contacter.php?cible='.$vmembre.'">'.$vmembre.'</a> : <strong>'.$vintitule.'</strong> :</p>');
		print('<p align="center">'.$vcontenu.'</div>');
		...
		if($res1>0)
			...
			{
			print('<hr><p align="center">Etes-vous -<a href="engine=consultpropterm.php?vote=Oui&id='.$_SERVER['QUERY_STRING'].'">Pour</a>- ou -<a href="engine=consultpropterm.php?vote=Non&id='.$_SERVER['QUERY_STRING'].'">Contre</a>- cette Loi ?</p>');
			}
		}
	}
