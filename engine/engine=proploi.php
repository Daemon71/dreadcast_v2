...
if(($type=="chambre") && ($l!=1))
	{
	print('<form name="form1" method="post" action="engine=proploif.php"><p align="center"><em>Pour que votre Loi puisse &ecirc;tre vot&eacute;e, il faut qu\'elle soit pr&eacute;alablement valid&eacute;e par le Pr&eacute;sident de la chambre. Vous serez averti par message priv&eacute; de sa d&eacute;cision. </em><br><br>Intitulé de la Loi : <input name="intitule" type="text" id="titre" size="16" maxlength="100"><br><textarea name="contenu" cols="45" rows="9" id="contenu"></textarea><br><input type="submit" name="Submit" value="Proposer la Loi au Pr&eacute;sident"></p></form>');
	}
