...
if($_GET['suppr']=="ok")
	...
	for($i=0;$i!=$res4;$i++)
		{
		$sql = 'INSERT INTO messages_tbl(id,auteur,cible,message,objet,moment,nouveau) VALUES("","'.$_SESSION['cercle'].'","'.mysql_result($req4,$i,pseudo).'","Le cercle vient d\'être dissoud par '.$_SESSION['pseudo'].'.","Info Cercle","'.time().'","oui")' ;
		}
	...
	{
	print('<strong>Êtes-vous vraiment sûr de vouloir dissoudre le cercle ?</strong><br />Si c\'est le cas toutes les éventuelles personnes du cercle seront renvoyées.<br /><br /><a href="engine=cercledissoudre.php?suppr=ok">Oui</a> - <a href="engine=cercle.php">Non</a>');
	}
