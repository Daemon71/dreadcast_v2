...
<div id="haut">
	...
	<div class="haut_aligngauche">
		...
		<b class="module4ie"><a href="engine=cerclevotes.php" class="module4"><img src="im_objets/icon_retour.gif" alt="Retour" />Retour</a></b>
</p>
	</div>
</div>
<div id="centre">
...
if($_GET['suppr']=="oui")
	...
	if((ereg("tout",$bddc)) || (ereg("actualite",$bddc)))
		{
		$sql = 'DELETE FROM cerclesvotes_tbl WHERE id="'.$_GET['id'].'"' ;
		$req = mysql_query($sql);
		$sql = 'DELETE FROM cerclesvotesperso_tbl WHERE idvote="'.$_GET['id'].'"' ;
		$req = mysql_query($sql);
		print('<strong>La nouvelle est effacée.</strong>');
		}
	else
		{
		print('<meta http-equiv="refresh" content="0 ; url=http://v2.dreadcast.net/ingame/engine=cercle.php"> ');
	...
	{
	print('Êtes-vous sûr de vouloir supprimer le vote n°'.$_GET['id'].' ?<br /><br />
	<a href="engine=cerclesupprvote.php?id='.$_GET['id'].'&suppr=oui">Oui</a> - <a href="engine=cerclevotes.php">Non</a>');
	}
