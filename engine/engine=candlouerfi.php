...
$sql2 = 'INSERT INTO candlouer_tbl(id,candidat,num,rue,demande) VALUES("","'.$_SESSION['pseudo'].'","'.$_GET['num'].'","'.$_GET['rue'].'","'.$_POST['demande'].'")' ;
$req2 = mysql_query($sql2);
...
<em>Votre message &agrave; bien &eacute;t&eacute; envoy&eacute; au propri&eacute;taire du logement.<br>
  Il vous fournira une r&eacute;ponse le plus rapidement possible. </em>
