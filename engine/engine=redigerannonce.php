...
<div id="haut">
	...
	<div class="haut_aligngauche">
		...
		<b class="module4ie"><a href="engine=aitl.php?type=pa" class="module4"><img src="im_objets/icon_retour.gif" alt="Retour" />Retour</a></b>
</p>
	</div>
</div>
<div id="centreaitl">
	...
	if((statut($_SESSION['statut'])>=2) || ($_SESSION['case1']=="AITL") || ($_SESSION['case2']=="AITL") || ($_SESSION['case3']=="AITL") || ($_SESSION['case4']=="AITL") || ($_SESSION['case5']=="AITL") || ($_SESSION['case6']=="AITL"))
		...
		if($_POST['annonce']!="")
			...
			if($_SESSION['credits']>=50)
				...
				$req = mysql_query($sql);
				print('<br /><strong>Votre annonce est parue.</strong><br />Vous aurez une réponse par courrier si quelqu\'un est interressé.');
				}
			else
				{
				print('<br />Vous n\'avez pas assez de Crédits en poche pour déposer cette annonce.');
				}
			}
		else
			{
			print('<br />Poster une petite annonce coûte 50 Crédits.<br />Chaque annonce reste en place 3 jours avant de disparaître.<br />
			<form method="post" action="engine=redigerannonce.php">
			<p align="center">Titre: <input type="text" name="titre" size="20" maxlenght="30" /><br /><br />
			Contenu:<br /><textarea cols="40" rows="9" name="annonce"></textarea>
