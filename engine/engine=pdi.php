...
if(isset($_GET['Oui']))
{
    $a_check = array("Passe DI2RCO", "Passe Invalide");
    $a_final = get_all_objets($a_check, count($a_check));
    replace_objects($a_final, $i_obj_number);
    print('Tous les Passes DI2RCO en vigeur sont maintenant désactivés.<br>');
}
else
{
    print('Voulez-vous vraiment invalider tous les Passes DI2RCO en circulation ?<br><form action="#" method="get"><input tabindex="1" type="submit" name="Oui" value="Oui"/></form>');
}
?>
<div>
</div>
