...
for($i=1; $i != 7; $i++)
	{
	if(($_SESSION['case'.$i.'']=="Caisse de nourriture") && ($deja!=1))
		{
		...
		if($niveau<$niveau_max)
			...
			$req = mysql_query($sql);
			print("<center><strong>Vous venez de déposer une caisse de nourriture dans le refrigérateur du</strong><br><br>");
