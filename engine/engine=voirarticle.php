...
<div id="haut">
	...
	<div class="haut_aligngauche">
		...
		<b class="module4ie"><a href="engine=panneaua.php" class="module4"><img src="im_objets/icon_retour.gif" alt="Retour" />Retour</a></b>
</p>
	</div>
</div>
<div id="centre">
...
if($_SESSION['statut']=="Administrateur" OR $l!=1)
	...
	$sql = 'SELECT * FROM articlesprop_tbl WHERE id= "'.htmlentities($_GET['id']).'"' ;
	$req = mysql_query($sql);
	...
	if($res!=0)
		...
		print('<p align="center">Article de <strong>'.$auteur.' :</strong></p>
		<p align="center" class="barre">'.$contenu.'</p>
		<p align="center"><a href="engine=accepterarticle.php?'.$_GET['id'].'">Accepter cet article</a>');
		print('<br><a href="engine=supprarticle.php?'.$_GET['id'].'">Refuser cet article</a></p>');
		print('</p>');
		}
	else
		{
		print("<br /><strong>Cet article ne peut pas s'afficher.</strong>");
		}
