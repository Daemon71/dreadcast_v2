...
echo'<table width="400" height="206" border="1">
  <tr>
    ...
    <td valign="top"><br /><div align="left"><form method="POST" action="engine=superslot2.php">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="width:50px;color:#EFE1FF;background:#2B2929;border:1px solid #4A4A4A;font-size:1.1em;" type="submit" value="Jouer" name="Jouer">
  ...
  <tr>
    <td valign="top" style="padding:5px;"><br />&nbsp;&nbsp;Chaque partie coute 20 crédits, pour jouer il suffit d\'appuyer sur le bouton "<strong>Jouer</strong>". <br />Vous pouvez à tout moment du jeu sortir avec la somme que vous souhaitez en appuyant sur le bouton "<strong>Sortir</strong>". <br />Il est possible de gagner jusqu\'à 1000 crédits en un seul coup!<br />Bonne Chance!</td>
  </tr>
</table>';
