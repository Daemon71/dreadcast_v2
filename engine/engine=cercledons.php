...
$sql = 'SELECT * FROM cerclesdon_tbl WHERE cercle= "'.$_SESSION['cercle'].'"' ;
$req = mysql_query($sql);
$res = mysql_num_rows($req);

if($res>0)
	{
	print('Archives des dons du cercle <strong>'.$_SESSION['cercle'].'</strong>:<br /><br /><div class="cercleactu"><table width="90%" bgcolor="#FFFFFF" border="1" align="center" cellpadding="0" cellspacing="0">
	<tr bgcolor="#B6B6B6">
	<th scope="col"><div align="center">De</div></th>
	<th scope="col"><div align="center">Montant</div></th>
	...
	{
	print('<div align="center"><strong>Aucun don dans votre cercle.</strong></div>');
	}
