...
$sqlach = 'DELETE FROM achats_tbl WHERE vendeur= "'.$_SESSION['entreprise'].'"' ;
$reqach = mysql_query($sqlach);

mysql_close($db);
?>
<img src="im_objets/loader.gif" alt="..." />
<meta http-equiv="refresh" content="0 ; url=http://v2.dreadcast.net/ingame/engine=listeacheteurs.php">
