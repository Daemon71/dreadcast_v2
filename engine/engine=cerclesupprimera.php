...
if($_GET['suppr']=="oui")
	...
	if((ereg("tout",$bddc)) || (ereg("actualite",$bddc)))
		{
		$sql = 'DELETE FROM cerclesnews_tbl WHERE id="'.$_GET['id'].'"' ;
		$req = mysql_query($sql);
		$sql = 'DELETE FROM cerclescom_tbl WHERE nouvelle="'.$_GET['id'].'"' ;
		$req = mysql_query($sql);
	...
	{
	print('Êtes-vous sûr de vouloir supprimer le nouvelle n°'.$_GET['id'].' ?<br /><br />
	<a href="engine=cerclesupprimera.php?id='.$_GET['id'].'&suppr=oui">Oui</a> - <a href="engine=cercleactu.php?id='.$_GET['id'].'">Non</a>');
	}
