...
$sql = 'UPDATE signaturesperso_tbl SET signature= "'.str_replace("\n","<br />",''.htmlentities($_POST["signature"],ENT_QUOTES).'').'" WHERE pseudo= "'.$_SESSION['pseudo'].'"';
$req = mysql_query($sql);

mysql_close($db);
?>
<meta http-equiv="refresh" content="0 ; url=http://v2.dreadcast.net/ingame/engine=signatureperso.php">
