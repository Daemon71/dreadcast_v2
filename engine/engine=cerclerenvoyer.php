...
<table width="450" height="250" bgcolor="#FFFFFF" border="1" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td><div align="center">
			<?php
			print('Êtes-vous sûr de vouloir renvoyer <strong>'.$_SERVER['QUERY_STRING'].'</strong> ?<br /><br /><a href="engine=cerclerenvoyerconf.php?'.$_SERVER['QUERY_STRING'].'">Oui</a> - <a href="engine=cercle.php">Non</a>');
			?>
		</div></td>
	</tr>
</table>
