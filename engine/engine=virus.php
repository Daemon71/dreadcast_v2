...
for($i=1; $i != 7; $i++)
	{
	if(($_SESSION['case'.$i.'']=="Virus") && ($l!=1))
		{
		if($_SESSION['malade']==0)
			{
			$l = 1;
			$_SESSION['malade'] = 1;
			...
			$req = mysql_query($sql);
			print('<p align="center"><strong>Vous venez de vous injecter le virus du Faucheur.</strong><br /><br />');
			print('Vous êtes maintenant contaminé.</p>');
			}
		else
			{
			$l = 1;
			print("<center><strong>Vous êtes déjà atteind ou vacciné !</strong></center><br>");
			}
		}
	}
