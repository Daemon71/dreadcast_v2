...
if(($type=="chambre") && ($l!=1))
	...
	if($_POST['intitule']=="")
		{
		print('<p align="center">Vous devez entrer un intitulé pour votre Loi.</p>');
		$l = 1;
		}
	elseif($_POST['contenu']=="")
		{
		print('<p align="center">Vous devez entrer un contenu pour votre Loi.</p>');
		$l = 1;
		}
	else
		{
		$sql1 = 'INSERT INTO loisprop_tbl(id,intitule,contenu,membre) VALUES("","'.$_POST['intitule'].'","'.str_replace("\n","<br />",''.htmlentities($_POST["contenu"],ENT_QUOTES).'').'","'.$_SESSION['pseudo'].'")' ;
		$req1 = mysql_query($sql1);
		print('<p align="center">Votre proposition de Loi est maintenant entre les mains du Premier Consul.<br>Vous recevrez un message privé lorsqu\'une décision sera prise.</p>');
		}
	}
