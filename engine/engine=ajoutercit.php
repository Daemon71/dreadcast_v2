...
if($_SESSION['statut']=="Administrateur" OR $l!=1)
	...
	if($_POST['contenu']!="")
		{
		$sql = 'INSERT INTO citations_tbl(id,auteur,citation,paru) VALUES("","'.htmlentities(stripslashes($_POST['auteur'])).'","'.htmlentities(stripslashes($_POST['contenu'])).'","non")' ;
		$req = mysql_query($sql);
		print('La citation a été ajouté. Elle sera paru d\'ici quelques jours.');
		}
	else
		{
		print('<form action="#" method="post">
		Auteur: <input name="auteur" type="text" size="10" /><br /><br />
		Citation:<br /><br /><textarea name="contenu" rows="6" cols="40"></textarea><br /><br />
