...
if($res!=0)
	...
	if($res1!=0)
		...
		if($type=="usine de production")
			...
			if($nombres>=1)
				{
				print('Vendre un stock au prix de production ?<br /><br /><a href="engine=vendre.php?'.$objet.'">Oui</a> - <a href="engine=stocksconsult.php?'.$objet.'">Non</a>');
				}
			else
				{
		...
		elseif($type=="agence immobiliaire")
			...
			if($nombre>=1)
				{
				print('Vendre un logement au prix de production ?<br /><br /><a href="engine=vendre.php?'.$objet.'">Oui</a> - <a href="engine=stocksconsult.php?'.$objet.'">Non</a>');
				}
			else
				{
				print('<meta http-equiv="refresh" content="0 ; url=http://v2.dreadcast.net/ingame/engine=stocks.php"> ');
