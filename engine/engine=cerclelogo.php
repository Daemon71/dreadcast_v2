	  ...
	  <td>
		  <div align="center">
			...
			if($_POST['logo']!="")
				...
				$sql = 'UPDATE cerclesliste_tbl SET logo= "'.$_POST['logo'].'" WHERE nom= "'.$_SESSION['cercle'].'"' ;
				$req = mysql_query($sql);
				print('<strong>Le logo de votre cercle est changé.</strong>');
				...
				{
				print('Vous pouvez importer votre propre logo en entrant le lien qui pointe vers l\'image dans le champ suivant.<br /><br />
				<form action="#" method="post">Lien: <input type="text" name="logo" size="50" /> <input type="submit" value="Ok" /></form>');
			  	}
			?>
		  </div>
	  </td>
