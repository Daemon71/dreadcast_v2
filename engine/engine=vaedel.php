...
$sqlv = 'SELECT id FROM vente_tbl WHERE vendeur= "'.$_SESSION['pseudo'].'" AND id= "'.$_GET['id'].'"' ;
...
<p id="textelse">
	&Ecirc;tes-vous vraiment s&ucirc;r de vouloir annuler la vente ?<br /><br />
	<a href="engine=vaedelconf.php?id=<?php print(''.$_GET['id'].''); ?>">Oui</a> - <a href="engine=vaeges.php">Non</a>
</p>
